...
if (request.getMethod().equals("GET")) {
    ...
    if (s1 == null || s1.length() == 0) 
        ...
        response.sendRedirect("studentList.jsp?pg=" + pg + "&name=" + nameEncoded);
...
<form method="post">
  ...
  <a href="studentDelete.jsp?id=<%= id %>&pg=<%= pg %>&name=<%= nameEncoded %>" 
     class="btn btn-danger" onclick="return confirm('삭제하시겠습니까?')">
    <i class="glyphicon glyphicon-trash"></i> 삭제
  </a>
  <a href="studentList.jsp?pg=<%= pg %>&name=<%= nameEncoded %>" 
