	...
	<div class="container">
		<form method="get">
			...
			<div class="form-group">
				<label>number1</label>
				<input type="text" name="number1" class="form-control" value="34" /> <!-- 파라미터의 존재유무 상관없이 34가 출력된다. -->
			</div>
			...
			<div class="form-group">
				<label>number2</label> <input type="text" name="number2" class="form-control" value="8" /><!-- 파라미터의 존재유무 상관없이 8이 출력된다. -->
			</div>
